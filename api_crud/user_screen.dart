...
//   void showUserDialog({int? id, String? existingName, String? existingEmail}) {
//     if (id != null) {
...
//                 mainAxisSize: MainAxisSize.min,
//                 children: [
//                   IconButton(icon: Icon(Icons.edit), onPressed: () => showUserDialog(id: user['id'], existingName: user['name'], existingEmail: user['email'])),
